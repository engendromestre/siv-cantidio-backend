...
import { VideoInMemoryRepository } from '../../core/patient/infra/db/in-memory/patient-in-memory.repository';
import { IVideoRepository } from '../../core/patient/domain/video.repository';
import { UnitOfWorkSequelize } from '../../core/shared/infra/db/sequelize/unit-of-work-sequelize';
import { IUnitOfWork } from '../../core/shared/domain/repository/unit-of-work.interface';
import { CATEGORY_PROVIDERS } from '../categories-module/categories.providers';
import { VideoSequelizeRepository } from '../../core/patient/infra/db/sequelize/video-sequelize.repository';
import { VideoModel } from '../../core/patient/infra/db/sequelize/patient.model';
...
import { CreateVideoUseCase } from '../../core/patient/application/use-cases/create-video/create-video.use-case';
...
import { UpdateVideoUseCase } from '../../core/patient/application/use-cases/update-video/update-video.use-case';
import { UploadAudioVideoMediasUseCase } from '../../core/patient/application/use-cases/upload-audio-video-medias/upload-audio-video-medias.use-case';
import { GetVideoUseCase } from '../../core/patient/application/use-cases/get-video/get-video.use-case';
import { ProcessAudioVideoMediasUseCase } from '../../core/patient/application/use-cases/process-audio-video-medias/process-audio-video-medias.use-case';
import { PublishVideoMediaReplacedInQueueHandler } from '../../core/patient/application/handlers/publish-video-media-replaced-in-queue.handler';
